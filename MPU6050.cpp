...
int MPU6050_Init(uint8_t* ret_addr, uint8_t* ret_pwr_mgm)
{
  int error;
  uint8_t c;
 ...
 //MPU6050_write_reg (MPU6050_I2C_MST_CTRL, 9);
...
int MPU6050_AquireRawData(accel_t_gyro_union* accel_t_gyro)
{
  int error;
  double dT;
...
void printRaw(accel_t_gyro_union* accel_t_gyro)
{
